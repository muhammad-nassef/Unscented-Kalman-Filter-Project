...
public:
  ...
  ///* number of times the Radar NIS exceeded the 95 % number
  long radar_nis_exceed_num_;

  ///* number of times the Lidar NIS exceeded the 95 % number
  long lidar_nis_exceed_num_;
  ...
  /**
     ...
     */
  void GetWeightsAndSigmaPts(const Eigen::VectorXd &state, const Eigen::MatrixXd &cov, double lambda,
